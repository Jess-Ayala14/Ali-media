...
export const Posted = (data) => {
    ...
    // DEL /2074988342714714_786642996281169/
    ...
    */
                    ...
                    <Card>
                        ...
                        <Card.Footer>
                            <Row>
                                <Col xs={10} sm={9} />
                                <Col xs={2} sm={2}>
                                    <Button variant='outline-danger' size='sm' onClick={() => handleShow(data = [post[0]])}>Del</Button>
                                </Col>
                            </Row>
                        </Card.Footer>
                    </Card>
    ...
    return (
        <>
            ...
            <ModalDelPost data={[show, handleClose, Del_posts, OffData]} />
